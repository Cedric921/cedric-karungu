    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative space-y-12">
          ...
          {/**Map through EXPERIENCES array to create timeline items**/}
            ...
            >
              ...
              <div className={`ml-12 md:ml-0 md:w-1/2 ${
                ...
                <div className="bg-gray-50 dark:bg-[#111] p-6 rounded-2xl border border-gray-200 dark:border-white/5 hover:border-accent-500/30 transition-all duration-300 group shadow-sm dark:shadow-none">
                  ...
                  {/**Period Badge, Role, Company, Location**/}
                  <div className={`flex flex-col gap-1 mb-4 ${
                    index % 2 === 0 ? 'items-start' : 'items-start md:items-end'
                  }`}>
                    
                    {/*Period Badge*/}
                    <span className="px-3 py-1 rounded-full bg-accent-100 dark:bg-accent-900/30 text-accent-700 dark:text-accent-300 text-xs font-semibold border border-accent-200 dark:border-accent-500/20">
                      {exp.period}
                    </span>
                    
                    {/*Job Title*/}
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-2 group-hover:text-accent-600 dark:group-hover:text-accent-400 transition-colors">
                      {exp.role}
                    </h3>
