  ...
  return (
    <section id="about" className="mt-[40px] py-24 scroll-mt-28 bg-gradient-to-br from-white via-slate-50 to-blue-50 dark:from-[#0a0a0a] dark:via-slate-900/50 dark:to-[#100B17] transition-colors duration-300 min-h-screen relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          {/* Image */}
          <motion.div className="lg:w-2/5 w-full flex justify-center" variants={itemVariants}>
            <motion.div
            ...
            >
              ...
              >
                <motion.p
                  ...
                  animate={isImageHovered ? { y: 0, opacity: 1 } : { y: 10, opacity: 0 }}
                  transition={{ duration: 0.3 }}
                >
                  {t('about.name')}
                </motion.p>
          ...
          {/* Content */}
          <motion.div className="lg:w-3/5 w-full space-y-6" variants={containerVariants}>
            {/* Desktop title */}
            ...
            <motion.div className="space-y-4" variants={containerVariants}>
              {[t('about.bio1'), t('about.bio2'), t('about.bio3')].map((bio, idx) => (
                <motion.p
                  key={idx}
