                ...
                <span className="relative z-10 flex items-center gap-1.5">
                  {isActive && (
                    <motion.span
                      ...
                      className="inline-block w-1.5 h-1.5 rounded-full bg-accent-500 shadow-[0_0_8px_rgba(139,92,246,0.8)]"
                      transition={{
                        type: "spring",
                        stiffness: 400,
                        damping: 28,
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{
                scale: 1.05,
                boxShadow:
                  "0 20px 30px rgba(139, 92, 246, 0.4), 0 8px 18px rgba(245, 158, 11, 0.25)",
              }}
              whileTap={{ scale: 0.95 }}
              transition={{ duration: 0.2 }}
            >
            ...
            <div className="px-6 py-4 space-y-3">
              {navLinks.map((link) => (
                <motion.a
                  ...
                  whileHover={{ x: 4, color: "rgb(139, 92, 246)" }}
                  transition={{ duration: 0.2 }}
                >
                  {link.name}
                </motion.a>
