    ...
    <section id="contact" className="py-24 relative overflow-hidden scroll-mt-28 bg-white dark:bg-[#050505] transition-colors duration-300" ref={ref}>
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <span className="inline-block px-4 py-1 rounded-full bg-accent-100 dark:bg-white/5 border border-accent-200 dark:border-white/10 text-accent-700 dark:text-accent-400 text-sm font-medium mb-4">Let's Connect</span>
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">Interested in a project or collaboration ?, Let’s discuss how we can work together to achieve your goals.</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-gray-50 dark:bg-[#111] p-8 rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-xs text-gray-500 dark:text-gray-400 ml-1">Name</label>
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-xs text-gray-500 dark:text-gray-400 ml-1">Email</label>
                  <input type="email" name="email" required placeholder="Your Email" className="w-full bg-white dark:bg-[#050505] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-accent-500 focus:ring-1 focus:ring-accent-500 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600" />
                </div>
              </div>

              <div className="space-y-2">
                <label htmlFor="subject" className="text-xs text-gray-500 dark:text-gray-400 ml-1">Subject</label>
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-xs text-gray-500 dark:text-gray-400 ml-1">Message</label>
                <textarea name="message" required placeholder="Your message here..." rows={4} className="w-full bg-white dark:bg-[#050505] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-accent-500 focus:ring-1 focus:ring-accent-500 transition-all resize-none placeholder:text-gray-400 dark:placeholder:text-gray-600"></textarea>
              </div>

              <button type="submit" className="w-full py-4 rounded-xl bg-accent-600 hover:bg-accent-500 text-white font-bold transition-all flex items-center justify-center gap-2 mt-4 shadow-lg shadow-accent-600/20">Send Message<Icons.Mail /></button>
            </form>
          </div>
        </div>
      </div>
