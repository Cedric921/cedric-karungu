        ...
        >
          ...
          <motion.div className="lg:col-span-1" variants={itemVariants}>
            ...
            <motion.div className="space-y-3" variants={containerVariants}>
              ...
              >
                <motion.span className="group-hover:scale-110 transition-transform duration-200" variants={iconVariants}>
                  <Icons.Mail />
                </motion.span>
              ...
              <motion.div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400" variants={itemVariants}>
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.ul className="space-y-3" variants={containerVariants}>
              {[
                { name: 'AdminAtete', url: 'https://home-adminatete.vercel.app/' },
                ...
                <motion.li key={project.name} variants={itemVariants}>
                  {project.url ? (
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400 cursor-default">{project.name}</span>
                  )}
                </motion.li>
              ))}
            </motion.ul>
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.div className="flex gap-4" variants={containerVariants}>
              <motion.a
                ...
                whileHover={{ scale: 1.2, color: 'rgb(124, 58, 237)', rotate: -12 }}
                transition={{ duration: 0.2 }}
              ...
              <motion.a
                href="mailto:ckarungu921@gmail.com"
                className="text-gray-500 dark:text-gray-500"
                whileHover={{ scale: 1.2, color: 'rgb(124, 58, 237)', y: -4 }}
                transition={{ duration: 0.2 }}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-6">
          <motion.div
            ...
            variants={containerVariants}
          >
            <motion.p className="text-xs text-gray-500 dark:text-gray-500 text-center md:text-left" variants={itemVariants}>
              © {currentYear} Cédric Karungu. {t('footer.copyright')}
            </motion.p>
            <motion.div className="flex items-center gap-6 text-xs text-gray-500 dark:text-gray-500" variants={containerVariants}>
              <motion.span
                whileHover={{ color: 'rgb(124, 58, 237)' }}
                transition={{ duration: 0.2 }}
              >
